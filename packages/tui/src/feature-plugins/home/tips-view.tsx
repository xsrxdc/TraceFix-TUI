...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent the agent from reading sensitive files",
  "Use {highlight}tracefix-tui run{/highlight} for non-interactive scripting",
  "Use {highlight}tracefix-tui --continue{/highlight} to resume the last session",
  "Use {highlight}tracefix-tui run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}tracefix-tui serve{/highlight} for headless API access",
  "Use {highlight}tracefix-tui run --attach{/highlight} to connect to a running server",
  "Run {highlight}tracefix-tui agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}tracefix-tui debug config{/highlight} to troubleshoot configuration",
